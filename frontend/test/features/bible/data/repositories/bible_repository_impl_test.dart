      ...
      (b) => b.insertAllOnConflictUpdate(
        ...
        [
          const VerseTranslationsCompanion(
            ...
            chapter: Value(1),
            verse: Value(1),
            text: Value('In the beginning God created the heaven and the earth.'),
          ),
          const VerseTranslationsCompanion(
            translationCode: Value('KJV'),
            bookId: Value(1),
            chapter: Value(1),
            verse: Value(2),
            text: Value('And the earth was without form, and void;'),
          ),
          const VerseTranslationsCompanion(
            translationCode: Value('KJV'),
            bookId: Value(1),
            chapter: Value(1),
            verse: Value(3),
            text: Value('And God said, Let there be light: and there was light.'),
          ),
          const VerseTranslationsCompanion(
            ...
            chapter: Value(1),
            verse: Value(1),
            text: Value('태초에 하나님이 천지를 창조하시니라'),
          ),
          const VerseTranslationsCompanion(
            translationCode: Value('KOREAN_RV'),
            bookId: Value(1),
